...
export default class AnimalItem {
  ...
  render() {
    return `
            ...
            <button id="edit-${this.id}" class="flex items-center justify-center p-2 bg-slate-200 rounded hover:bg-black-300">
            ...
            <button id="delete-${this.id}" class=" w-1/6 flex items-center justify-center rounded-md border border-transparent p-2.5 text-center text-sm transition-all text-slate-600 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" type="button">
