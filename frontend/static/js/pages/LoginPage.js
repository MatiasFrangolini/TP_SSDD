...
export default class LoginPage {
  ...
  async handleSubmit(event) {
    try {
      ...
      await AuthAPIHelper.login({ username, password });
      navigateTo("/");
    ...
    const formHtml = `
        ...
        <form id="login-form" class="w-1/4">
            ...
            <div class="input-container flex flex-col my-2">
                ...
                <input type="text" id="password" name="password" class="input-field bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-full-name" required>
            </div>
